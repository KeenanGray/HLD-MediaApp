...
public class Accessibility_Inspector : Accessibility_InspectorShared
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (showSounds)
		{
			EditorGUILayout.PropertyField(m_GoogleTTSAPIKey, new GUIContent("Google TTS API key", "You need to provide your Google Cloud API key to activate " +
			...
			if (m_GoogleTTSAPIKey.stringValue == null || m_GoogleTTSAPIKey.stringValue.Length < 39) 
			{
				...
				{
					Application.OpenURL("http://www.metalpopgames.com/assetstore/accessibility/doc/v1.0.5/WebGL.html");
				}
			}
