    ...
    : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void Start()
        {
            ...
            options.browserBackgroundColor =
                ColorUtility.ToHtmlStringRGB(new Color(0, 0, 0, 255));
        ...
        public void Init()
        {
            ...
            if (myBtn != null)
            {
                ...
                Debug
                    .LogWarning(gameObject.name +
                    ": There is no button component on this UI element. It cannot use the App_Button script without a button");
        ...
        void OnButtonPressed()
        {
            ...
            switch (Button_Opens)
            {
                case UIB_Button_Activates.Page:
                    ...
                    try
                    {
                        shouldDeActivatePage =
                            !newScreen.GetComponent<UIB_Page>().isTemplate;
                    }
                    catch (Exception e)
                    {
                    ...
                    newScreen
                        ...
                        .StartCoroutine("MoveScreenIn", false);
                    resetUAP = true;
                    break;
            ...
            {
                UIB_PageManager.LastPage =
                    GetComponentInParent<UIB_Page>().gameObject;
                GetComponentInParent<UIB_Page>().DeActivate();
            }
            if (resetUAP)
                StartCoroutine(GetComponentInParent<UIB_Page>()
                    .ResetUAP(false));
        ...
        public void SetButtonText(string newtext)
        {
            ...
            GetComponent<UAP_BaseElement>().AutoFillTextLabel();
        }
        ...
        {
            if (
                gameObject.name == "DISPLAYED-Info_Button" ||
                gameObject.name == "DISPLAYED-Code_Button"
            )
            {
                try
                {
                    // GetComponentInChildren<TextMeshProUGUI>().color = new Color(200, 197, 43,255);
                    buttonText.GetComponent<TextMeshProUGUI>().color =
                        new Color32(200, 197, 43, 255);
                }
                catch (Exception e)
                {
        ...
        public void SetupButtonColors()
        {
            ...
            if (GetComponent<UnityEngine.UI.Button>().image.sprite != null)
                originalColor =
                    GetComponent<UnityEngine.UI.Button>().image.color;
            else
